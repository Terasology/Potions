...
/**
 * This HerbEffect wraps any AlterationEffect so that the latter can function within the herbalism systems and be
 * treated as a HerbEffect.
 */
public class AlterationToHerbEffectWrapper implements HerbEffect {
    ...
    /**
     * Construct an instance of this wrapper using the given parameters. It can then be treated like any other
     * HerbEffect when calling the applyEffect methods.
     *
     ...
     */
    public AlterationToHerbEffectWrapper(AlterationEffect alterationEffect, float durationMultiplier,
    ...
    /**
     * Apply the wrapped alteration effect on the entity for the given magnitude and duration. Note that these two
     * values will be multiplied by magnitudeMultiplier and durationMultiplier respectively.
     *
    ...
    /**
     * Apply the wrapped alteration effect with a specific ID on the entity for the given magnitude and duration. Note
     * that these two values will be multiplied by magnitudeMultiplier and durationMultiplier respectively.
     *
     * @param instigator The instigator who is applying this effect on the entity. It can be a herb, potion,
     *         etc.
     * @param entity The entity who the herb effect is being applied on.
    ...
    public void applyEffect(EntityRef instigator, EntityRef entity, String id, float magnitude, long duration) {
        alterationEffect.applyEffect(instigator, entity, id, magnitude * magnitudeMultiplier,
                (long) (duration * durationMultiplier));
    }
