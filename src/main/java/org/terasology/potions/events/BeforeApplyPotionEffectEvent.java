...
/**
 * This event is sent to an entity to allow modification and/or cancellation of this particular PotionEffect of a
 * potion. The intended use-case is that one instance of this event will be sent per potion effect, so individual
 * effects of a potion can be cancelled.
 */
...
public class BeforeApplyPotionEffectEvent implements ConsumableEvent {
     ...
     */
    private final PotionEffect pEffect;
    ...
    /**
     * Get a reference to the original potion item that contains all of the PotionEffects - not just the one being
     * checked in this event.
     *
