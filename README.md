...
* Sacred - Regenerates 3 HP per second for 10 seconds, increases the user's base max health by 25% for 30 seconds, and also cures poison status when consumed.
...
* Sacred: WalkSpeedPotion1Bottle.png edited from base by smsunarto
